...
)
{
    ...
    if (!this->stop(solverPerf))
    {
        ...
        p = pTraits<Type>::zero_;
        Field<Type> ph(x.size(), pTraits<Type>::zero_);
        Field<Type> v(x.size(), pTraits<Type>::zero_);
        Field<Type> s(x.size(), pTraits<Type>::zero_);
        Field<Type> sh(x.size(), pTraits<Type>::zero_);
        Field<Type> t(x.size(), pTraits<Type>::zero_);
