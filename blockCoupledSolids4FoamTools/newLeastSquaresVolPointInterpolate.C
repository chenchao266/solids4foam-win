...
//                     Field<Type> allFaceData(nAllFaces, pTraits<Type>::zero_);
        ...
        if (mesh().globalData().nGlobalPoints())
        {
            ...
            for (label k=0; k<mesh().globalData().nGlobalPoints(); k++)
            {
                ...
                if (curSpIndex != -1)
                {
                    ...
                    Field<Type> allCellData(nAllCells, pTraits<Type>::zero_);
