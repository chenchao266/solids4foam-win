...
#endif
{
    ...
    else
    {
        ...
        (
            ...
            dimensionedVector("zero", dimAcceleration, vector::zero_)
        );
#endif
    }
}
    ...
    (
      ...
      : new volVectorField
        (
            ...
            mesh(),
            dimensionedVector("zero", dimVelocity, vector::zero_)
        )
    ),
    pPtr_
    (
    ...
    (
      ...
      : new volTensorField
        (
            ...
            mesh(),
            dimensionedTensor("zero", dimVelocity/dimLength, tensor::zero_)
        )
    ),
    gradpPtr_
    (
      ...
      : new volVectorField
        (
            ...
            mesh(),
            dimensionedVector("zero", p().dimensions()/dimLength, vector::zero_)
        )
    ),
    phiPtr_
    (
