...
Foam::linearElasticMisesPlastic::materialTangentField() const
{
    ...
    (
        new Field<symmTensor4thOrder>(mesh().nFaces(), symmTensor4thOrder::zero_)
    );
#ifdef OPENFOAMESIORFOUNDATION
    ...
    else // Analytical tangent
    {
        ...
        symmTensor4thOrder I4 = symmTensor4thOrder::zero_;
        I4.xxxx() = 1.0;
        I4.yyyy() = 1.0;
        I4.zzzz() = 1.0;
        I4.xyxy() = 1.0;
        ...
        // itself
        symmTensor4thOrder I2 = symmTensor4thOrder::zero_;
        I2.xxxx() = 1.0;
        I2.xxyy() = 1.0;
        I2.xxzz() = 1.0;
        I2.yyyy() = 1.0;
        ...
        symmTensor4thOrder nSquared = symmTensor4thOrder::zero_;
