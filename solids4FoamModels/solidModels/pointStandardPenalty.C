...
:
    ...
    slavePressure_(mesh.boundaryMesh()[slavePatchID].nPoints(), vector::zero_),
...
// // #ifdef OPENFOAMESIORFOUNDATION
// //     slavePressureVolField_.primitiveFieldRef() = vector::zero_;
// //     areaInContactVolField_.primitiveFieldRef() = 0.0;
// // #else
// //     slavePressureVolField_.internalField() = vector::zero_;
