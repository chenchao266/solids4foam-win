...
bool coupledUnsLinGeomSolid::evolve()
{
    ...
    do
    {
        ...
        vectorField AxDivSigma = vectorField(solutionVec_.size(), vector::zero_);
        ...
        vectorField AxD2dt2RhoG =
            vectorField(solutionVec_.size(), vector::zero_);
        ...
        vectorField Ax = vectorField(solutionVec_.size(), vector::zero_);
        ...
        {
            contrib.internalField()[faceCells1[faceI]] = vector::zero_;
        }
        contrib.write();
