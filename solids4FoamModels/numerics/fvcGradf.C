...
//     axisymmetric = false;
    ...
    if (!axisymmetric)
    {
        ...
        forAll(gradI, faceI)
        {
            ...
            gradI[faceI] = pTraits<GradType>::zero_;
            scalar faceArea = 0;
        ...
        forAll(tGrad().boundaryField(), patchI)
        {
            ...
            forAll(patchGrad, faceI)
            {
                ...
                patchGrad[faceI] = pTraits<GradType>::zero_;
                scalar faceArea = 0;
...
)
{
    ...
    forAll(owner, faceI)
    {
        ...
        else
        {
            ...
            point centrePoint = point::zero_;
            Type cf = pTraits<Type>::zero_;
    ...
    forAll(mesh.boundaryMesh(), patchI)
    {
        ...
        //GradType test = pTraits<GradType>::zero_;
