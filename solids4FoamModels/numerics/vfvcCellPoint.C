...
)
{
    ...
    (
        ...
        (
            ...
            dimensionedVector
            (
                "zero", pointT.dimensions()/dimLength, vector::zero_
            ),
            "zeroGradient"
        )
    );
...
)
{
    ...
    (
        ...
        (
            ...
            dimensionedTensor
            (
                "zero", pointD.dimensions()/dimLength, tensor::zero_
            ),
            "zeroGradient"
        )
    );
...
)
{
    ...
    // Create result field
    tmp<vectorField> tresult(new vectorField(pointDI.size(), vector::zero_));
#ifdef OPENFOAMESIORFOUNDATION
...
)
{
    ...
    // Create result field
    tmp<vectorField> tresult(new vectorField(pointPI.size(), vector::zero_));
#ifdef OPENFOAMESIORFOUNDATION
    vectorField& result = tresult.ref();
#else
    vectorField& result = tresult();
