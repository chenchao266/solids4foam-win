...
:
    ...
    MeshObject<Foam::fvMesh, Foam::MoveableMeshObject, cellPointLeastSquaresVectors>(mesh),
#else
...
void Foam::cellPointLeastSquaresVectors::makeLeastSquaresVectors() const
{
    ...
    vectorField cellAvPoint(mesh.nCells(), vector::zero_);
    ...
    symmTensorField dd(mesh.nCells(), symmTensor::zero_);
    ...
    forAll(ls, cellI)
    {
        ...
        curLs.resize(curCellPoints.size(), vector::zero_);
    ...
    forAll(ls, cellI)
    {
        ...
        vector cellAvLsVec = vector::zero_;
        forAll(curCellPoints, cpI)
        {
