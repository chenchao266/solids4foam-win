...
:
    ...
    MeshObject<fvMesh, Foam::MoveableMeshObject, pointPointLeastSquaresVectors>(mesh),
#else
...
void Foam::pointPointLeastSquaresVectors::makeLeastSquaresVectors() const
{
    ...
    symmTensorField dd(mesh.nPoints(), symmTensor::zero_);
    ...
    forAll(ls, pointI)
    {
        ...
        curLs.resize(curPointPoints.size(), vector::zero_);
