...
bool Foam::newDynamicBodyFvMesh::update()
{
...

    {
        vector trans =
            translationAmplitude_
           *(
                sin(2*constant::mathematical::pi*translationFrequency_*curTime)
              - sin(2*constant::mathematical::pi*translationFrequency_*oldTime)
            )
           *translationDirection_;
        ...
        scalar rotAngle =
            rotationAmplitude_
           *(
                sin(2*constant::mathematical::pi*rotationFrequency_*curTime)
              - sin(2*constant::mathematical::pi*rotationFrequency_*oldTime)
            );
