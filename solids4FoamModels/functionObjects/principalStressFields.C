...
)
{
    ...
    (
        ...
        mesh,
        dimensionedVector("sigmaMaxDir", dimPressure, vector::zero_)
    );
    ...
    (
        ...
        mesh,
        dimensionedVector("sigmaMidDir", dimPressure, vector::zero_)
    );
    ...
    (
        ...
        mesh,
        dimensionedVector("sigmaMinDir", dimPressure, vector::zero_)
    );
